...
class DaemonConfig:
    ...
    def register_instance(self, instance_id: str, pid: int, api_port: int,
                         working_directory: str, status: str = 'running'):
